...
const de: Dict = {
  ...
  'misc.walkHint': 'Klick Gang · WASD · R = Platz',

  'peek.tab.overview': 'Überblick',
  'peek.tab.gens': 'Sachen',
  'peek.tab.steal': 'Klauen',
  'peek.walking': 'läuft rum',
  'peek.atDesk': 'am Platz',
  'peek.deskTier': 'Pult-Stufe {n}',
  'peek.gensTitle': 'Top-Käufe',
  'peek.noGens': 'Noch nichts gekauft.',

  'activity.title': 'Klassenzimmer',
  'activity.click': '{n} schreibt mit',
  'activity.buy': '{n} kauft {g}',
  'activity.upgrade': '{n} upgraded',
  'activity.prestige': '{n} versetzt sich',
  'activity.steal': '{n} → {v}',
  'activity.quiz': '{n} bestand Kurztest',

  'steal.mustSit': 'Erst am Platz sitzen!',
  'err.walking': 'Erst am Platz sitzen!',
  'walk.return': 'Zum Platz',
...
const en: Dict = {
  ...
  'misc.onHand': 'on hand',
  'misc.walkHint': 'Click aisle · WASD · R = seat',

  'peek.tab.overview': 'Overview',
  'peek.tab.gens': 'Gear',
  'peek.tab.steal': 'Steal',
  'peek.walking': 'walking around',
  'peek.atDesk': 'at desk',
  'peek.deskTier': 'Desk tier {n}',
  'peek.gensTitle': 'Top purchases',
  'peek.noGens': 'Nothing bought yet.',

  'activity.title': 'Classroom',
  'activity.click': '{n} is taking notes',
  'activity.buy': '{n} buys {g}',
  'activity.upgrade': '{n} upgraded',
  'activity.prestige': '{n} graduated',
  'activity.steal': '{n} → {v}',
  'activity.quiz': '{n} passed the quiz',

  'steal.mustSit': 'Sit at your desk first!',
  'err.walking': 'Sit at your desk first!',
  'walk.return': 'To desk',
